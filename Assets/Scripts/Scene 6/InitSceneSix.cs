...
public class InitSceneSix : MonoBehaviour
{
	...
	void Start()
	{
		...
		//set text
		textToSpeechArr[0].text = GameManager.sixthScene.introText;
		textToSpeechArr[1].text = GameManager.sixthScene.sceneText;
		textTyper.text = GameManager.sixthScene.introText;
